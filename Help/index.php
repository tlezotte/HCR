...
<html><!-- InstanceBegin template="/Templates/vnmain.dwt.php" codeOutsideHTMLIsLocked="false" -->
  ...
  <body <?= $ONLOAD; ?>>
          ...
          <td width="100%" colspan="3">
            ...
            <table cellspacing="0" cellpadding="0" width="100%" summary="" border="0">
              <tbody>
				...
				<!-- InstanceBeginEditable name="leftMenu" --><!-- #BeginLibraryItem "/Library/lm_help.lbi" -->
    ...
    <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="200" align="center" valign="top"><br></td>
        <td align="center"><br>
            <br>
            <br>
            <br>
      ...
      <span class="NavBarInactiveLink">Choose from the menu on the left side of the screen <br>
        ...
        <td width="200" align="center" valign="top"><table width="98%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25" valign="middle" class="BGAccentVeryDark">&nbsp;&nbsp;<strong>Recent Changes</strong> </td>
          </tr>
          <tr>
            <td valign="top" class="BGAccentVeryDarkBorder"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top" class="NavBarInactiveLink"><img src="../images/newred.gif" width="34" height="15">
                      <a href="../security/fixIE.reg">Registry Fix for Internet Explorer</a></td>
                </tr>
            </table></td>
          </tr>
        </table></td>
