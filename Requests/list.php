                ...
                <form action="" method="get" style="margin: 0">
                  <table>
                    <tr>
                      ...
                      <td class="currentnew" title="Help|Select the Request Type to filter the List.">Type</td>
                      <?php } ?>
                      <td class="currentnew" title="Help|Select the Status of a Request to filter the List.">Status</td>
                      <?php if ($_SESSION['hcr_groups'] == 'ex' OR $_SESSION['hcr_groups'] == 'hr') { ?>
                      <td rowspan="2"><img src="/Common/images/spacer.gif" width="15" height="5" /></td>
                      <td class="currentnew" title="Help|View only My Requests.">My</td>
                      <?php } ?>
                    </tr>
                    <tr>
                      <?php if ($_SESSION['hcr_groups'] == 'ex' OR $_SESSION['hcr_groups'] == 'hr') { ?>
                      ...
                      <td><select name="status" id="status" onChange="this.form.submit();" class="listoptions">
                        ...
                        <option value="O" <?= ($_GET['status'] == 'O') ? selected : $blank; ?>>Completed</option>
                        <option value="D" <?= ($_GET['status'] == 'D') ? selected : $blank; ?>>Denied</option>
                        <option value="C" <?= ($_GET['status'] == 'C') ? selected : $blank; ?>>Canceled</option>
                      </select></td>
                      <td><input name="my" type="checkbox" id="my" value="true" <?= ($_SESSION['hcr_groups'] != 'ex') ? 'disabled' : $blank; ?> <?= ($_GET['my'] == 'true' OR $_SESSION['hcr_groups'] != 'ex') ? checked : $blank; ?> onChange="this.form.submit();" /></td>
                    </tr>
                  </table>
                    ...
                    YAHOO.util.Event.addListener(window, "load", function() {
                        YAHOO.example.XHR_XML = new function() {
                            ...
                            this.formatRequestLevel = function(elCell, oRecord, oColumn, sData) {
                                ...
                                elCell.innerHTML = "<img src='/Common/images/" + level + ".gif' title='" + oRecord.getData("level") + "' />";
                            };	
                            ...
                            this.myDataSource = new YAHOO.util.DataSource("requests_xml.php?");
