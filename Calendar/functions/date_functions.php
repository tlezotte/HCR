...
$return = "
    ...
    // --></script>";
			...
			//$message=$escaped_date."<br>".$escaped_time."<br>".$escaped_uid;
			$return .= '<a class="'.$link_class.'" title="'.$title.'" href="#" onclick="openEventWindow('.$popup_data_index.'); return false;">';
			//$return .= "<a class=\"".$link_class."\" title=\"".$title."\" href=\"#\" onmouseover=\"return overlib('$message', CAPTION, 'Event Details', STICKY, TEXTPADDING, 10, WIDTH, 300, WRAPMAX, 300, AUTOSTATUS, BGCOLOR, '#E68B2C', CGCOLOR, '#E68B2C', FGCOLOR, '#FFFF99');\" onmouseout=\"nd();\">";
			$popup_data_index++;
		} else {
