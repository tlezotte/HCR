...
$template 				= 'company';		// Template support
...
$day_end				= '1800';			// End time for day grid
...
$timezone 				= 'America/Detroit';				// Set timezone. Read TIMEZONES file for more information
...
$default_path			= 'https://hr.yourcompany.com/go/HCR/Calendar'; 				// The HTTP URL to the PHP iCalendar directory, ie. http://www.example.com/phpicalendar
...
$ftp_calendar_path		= 'calendars';				// Only used if $auth_method='ftp'. The full path to the calendar directory on the ftp server. If = '', will attempt to deduce the path based on $calendar_path, but may not be accurate depending on ftp server config.
