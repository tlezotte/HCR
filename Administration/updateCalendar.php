 ...
 * - Calendar Library
 */
require_once('../include/functionsCalendar.php'); 


if ($_GET['type'] == 'Actual' OR $_GET['type'] == 'Desired') {
	iCalendar($_GET['type']);
}
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td height="30" nowrap class=
                                  "DarkHeaderSubSub">&nbsp;&nbsp;Update Calendar...</td>
                          ...
                          <tr>
                            <td class="BGAccentDarkBorder"><table width="100%"  border="0">
                                <tr class="BGAccentLight">
                                  <td height="25"><a href="<?= $_SERVER['PHP_SELF']."?type=Actual"; ?>"><img src="../images/button.php?i=b150.png&l=Actual" border="0" align="absmiddle"></a></td>
                                </tr>
                                <tr class="BGAccentLight">
                                  <td>
                                    <div align="left"><a href="<?= $_SERVER['PHP_SELF']."?type=Desired"; ?>"><img src="../images/button.php?i=b150.png&l=Desired" border="0" align="absmiddle"></a></div></td></tr>
                            </table></td>
                          </tr>
                      </table></td>
                    </tr>
