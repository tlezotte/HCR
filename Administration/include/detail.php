...
if ($_SESSION['hcr_access'] == '3') {  
	...
	if ($_POST['action'] == 'console') {
		switch ($_POST['task']) {
			...
			break;
			case 'switchApprover':
				if (array_key_exists('controller', $_POST)) { $dbh->query("UPDATE Authorization SET controller='" . $_POST['controller'] . "' WHERE type_id=" . $_POST['id']); }
...
/* Get list of users */
$employees_sql = "SELECT E.fst, E.lst, U.eid, U.groups, E.username
				   FROM  Users U
