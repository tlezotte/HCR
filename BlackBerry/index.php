...
if (isset($_POST['username']) OR isset($_COOKIE['username'])) {
	if (isset($_COOKIE['username'])) {
		...
		$login_query = $dbh->prepare("select e.username, e.password, u.access, u.eid
									  ...
									  where u.eid = e.eid and e.username like '".$_POST['username']."' and u.status = '0' and e.status = '0';");
	...
	//	  if ($login['vacation'] != '0') {
	//		$forward = 'Administration/vacation.php';
	//	  } else {
			$forward = (isset($_SESSION['redirect'])) ? $_SESSION['redirect'] : "home.php";
	//	  }
		} else {
          ...
          <td>
            ...
            <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" name="login" id="login" style="margin: 0">
              ...
              <table width="220" border="0" cellpadding="0" cellspacing="0" class="transform_rule">
                ...
                <tr>
                  <td height="5"><input name="remember" type="checkbox" id="remember" value="yes">
                      <span class="NavBarActiveLink">Remember Login</span></td>
                </tr>
                <tr>
                  <td><div align="right">
