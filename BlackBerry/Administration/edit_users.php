...
if ($_GET['action'] == 'details') { 
	$USERS = $dbh->getRow("SELECT E.eid, E.fst, E.lst, E.username, E.email, E.password, U.access, U.requester, U.one, U.two, U.three, U.staffing, U.status 
							 FROM Users U, Standards.Employees E 
							 WHERE U.eid = E.eid
							   AND U.eid=".$_GET['eid']);
...
<table width="240"  border="0">
  ...
  <tr bgcolor="DFDFBF">
    <td bgcolor="#<?= $row_color; ?>"><img src="../../images/wait0.gif" width="18" height="20" border="0" align="absmiddle">&nbsp;<a href="<?= $staffing_url; ?>" class="<?= $staffing_class; ?>"><?= $staffing_message; ?></a></td>
  </tr>
  <tr bgcolor="FFFFFF">
